...
import { getFaucetHost, requestBfcFromFaucetV1 } from "@benfen/bfc.js/faucet";
...
const exampleMnemonic =
  "regret curious ridge evil unaware tuition task length unique advance cupboard retire";
...
const bfcAddress = hex2BfcAddress(address);
...
const Account_2_ADDRESS =
  "BFCed0028abcede548b9080f42656132c5fbffbd859e08946ce361638c3396cdb2617a3";

// const USDC_COIN_TYPE = '0xa1ec7fc00a6f40db9693ad1415d0c193ad3906494428cf252621037bd7117e29::usdc::USDC'

// 领水
async function getTestCoinFromFaucet(address) {
  requestBfcFromFaucetV1({
...
async function sendTokenTransaction(sender, recipient, amount, coinType) {
  ...
  // 过滤出指定类型的币
  const filteredCoins = allCoins.data.filter(
...
async function sendNativeTokenTransaction(sender, recipient, amount) {
  await sendTokenTransaction(sender, recipient, amount, BFC_TYPE_ARG);
}
